...
- [x] Footer "Propulsé par PRONTO by ALTMachine" sur toutes les vitrines publiques
...
- [x] Généraliser les libellés visibles « Menu » du dashboard en « Catalogue » sans modifier l’onglet legacy
...
- [x] Déplacer les overrides pnpm vers leur configuration reconnue et revalider l’audit de dépendances sans avertissement
...
- [x] Remplacer le parcours d’invitation Super Admin hérité par une création locale email/mot de passe sécurisée avant de le réactiver
- [x] Vérifier dans le panneau Super Admin la création, le hachage non exposé et la révocation d’une invitation locale
...
- [x] Respecter la préférence de mouvement réduit lors du défilement automatique des messages d’assistance
- [x] Ajouter des noms accessibles aux champs et actions iconiques du formulaire d’assistance
...
## DROITS GALERIE ET HORAIRES (20 août 2026)
...
## DROITS GESTION RÉSERVATIONS (20 août 2026)
- [x] Vérifier l’appartenance de l’établissement avant toute gestion, liste ou export de réservation
- [x] Ajouter les régressions inter-établissement des procédures de gestion de réservation

## AUDIT DROITS NOYAU ENTREPRISE (20 août 2026)
...
## EN-TÊTES HTTP DE SÉCURITÉ (20 août 2026)
...
## DÉCOUVRABILITÉ SEO SERVEUR (20 août 2026)
...
## NOTIFICATIONS DE RÉSERVATION — PRÉPARATION (20 août 2026)
- [x] Documenter le contrat de non-envoi et les secrets requis avant activation d’un fournisseur
- [ ] Choisir un fournisseur Email transactionnel et un fournisseur WhatsApp Business avant toute implémentation d’envoi
